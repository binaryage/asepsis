...
int main (int argc, const char * argv[]) {
    ...
    test_prefix("", DSCAGE_PREFIX, 1);
    test_prefix("a", DSCAGE_PREFIX "a", 1);
    test_prefix("/x", DSCAGE_PREFIX "/x", 1);
    test_prefix("/xxx/yyy/zzz", DSCAGE_PREFIX "/xxx/yyy/zzz", 1);
    test_prefix("/xxx/.DS_Store", DSCAGE_PREFIX "/xxx/.DS_Store", 1);
    test_prefix("/xxx/12345/some_file.txt", DSCAGE_PREFIX "/xxx/12345/some_file.txt", 1);
    ...
    test_prefix(LONG_PATH_980 "/abcdefghi.txt", DSCAGE_PREFIX LONG_PATH_980 "/abcdefghi.txt", 1); // still fits
